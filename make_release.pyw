...
def parse_args():
    parser = argparse.ArgumentParser(
        ...
        epilog="""Examples:
  make_release.pyw                          (Opens the PyQt interface without console)
  python make_release.pyw                   (Opens the PyQt interface)
  python make_release.pyw --cli --with-greatwood-patch --without-companion-spawner
"""
    )
